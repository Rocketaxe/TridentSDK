...
public interface TaskFactory {
     ...
     */
    ScheduledTask asyncRun(Plugin plugin, TridentRunnable runnable);
     ...
     * @return the task which was wrapped by the scheduler
     */
    ScheduledTask syncRun(Plugin plugin, TridentRunnable runnable);
     ...
     * @return the task which was wrapped by the scheduler
     */
    ScheduledTask asyncLater(Plugin plugin, TridentRunnable runnable, long delay);
     ...
     * @return the task which was wrapped by the scheduler
     */
    ScheduledTask syncLater(Plugin plugin, TridentRunnable runnable, long delay);
     ...
     * @return the task which was wrapped by the scheduler
     */
    ScheduledTask asyncRepeat(Plugin plugin, TridentRunnable runnable, long delay, long initialInterval);
     ...
     * @return the task which was wrapped by the scheduler
     */
    ScheduledTask syncRepeat(Plugin plugin, TridentRunnable runnable, long delay, long initialInterval);
}
